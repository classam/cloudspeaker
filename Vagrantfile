...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "vrcloud", "/home/vagrant/vrcloud"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo apt-get install -y ack-grep vim dos2unix git curl build-essential gcc postgresql-client
    echo "Install python dependencies to run dev environment"
